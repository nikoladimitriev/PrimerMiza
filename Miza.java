...
// Uvozimo vse razrede iz paketa za delo z V/I napravami in pripomočke, GUI in dogodke
import java.io.*;
import java.util.*;
import javax.swing.*;
...
public class Miza extends JFrame implements ActionListener {	
	...
	public Miza () {
		...
		povrsina.add(new JScrollPane(tabela));
	...
	/**
	 * Javna metoda, ki izvaja aktivnosti glede na dogodek.
	...
	public void actionPerformed(ActionEvent e) {
		...
		// Pivska steklenica dodamo v model tabele
